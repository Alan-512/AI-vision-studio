...
const translations = {
  en: {
    ...
    'settings.key_desc': 'Your API key is stored locally in your browser. System does not provide a default key, so you must enter your own Google Gemini API Key to use this application.',
  ...
  zh: {
    ...
    'settings.title': '设置',
    'settings.key_label': 'Google AI Studio API Key',
    'settings.key_desc': '您的 API 密钥仅存储在本地浏览器中。系统不提供默认密钥，您必须输入自己的 Google Gemini API Key 才能开始使用。',
    ...
    'chat.desc_video': '构思场景、运镜和提示词，复制到参数配置页生成视频。',
