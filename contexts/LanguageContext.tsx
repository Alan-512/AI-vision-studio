...
const translations = {
  en: {
    ...
    'lbl.thinking': 'Thinking Depth',
    'thinking.minimal': 'Minimal (Fast)',
    'thinking.high': 'High (Quality)',
    'lbl.count': 'Count',
    ...
    'settings.use_proxy': 'Network Acceleration',
    'settings.proxy_desc': 'Optimized for regions with unstable connections. Enables direct access without VPN.',
    ...
    'ratio.ONE_FOURTH': 'Tall (1:4)',
    'ratio.FOUR_ONES': 'Wide (4:1)',
    'ratio.ONE_EIGHTH': 'Tall (1:8)',
    'ratio.EIGHT_ONES': 'Wide (8:1)',
  ...
  zh: {
    ...
    'settings.use_proxy': '网络加速',
    'settings.proxy_desc': '针对特定地区优化的直连线路，开启后可免科学上网使用。',
    ...
    'ratio.ONE_FOURTH': '竖直 (1:4)',
    'ratio.FOUR_ONES': '超宽 (4:1)',
    'ratio.ONE_EIGHTH': '极竖 (1:8)',
    'ratio.EIGHT_ONES': '极宽 (8:1)',
    'builder.lighting': '光影',
