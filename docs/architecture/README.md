...
- `unified-agent-kernel-diagram.html`: current unified kernel overview and runtime flow for the AI image-generation workspace
- `agent-architecture-upgrade.md`: dynamic skill injection and agent architecture direction
- `agent-refactor-map.md`: phased refactor map for the current image-generation agent runtime
