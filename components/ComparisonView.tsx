      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden flex items-center justify-center pointer-events-none">
            ...
            <div className="absolute bottom-4 right-4 bg-brand-600/90 text-white text-xs font-bold px-3 py-1 rounded-full backdrop-blur-md">
              B
            </div>
          </div>
          ...
          <div className="absolute bottom-4 left-4 bg-brand-600/90 text-white text-xs font-bold px-3 py-1 rounded-full backdrop-blur-md z-10">
            A
          </div>
