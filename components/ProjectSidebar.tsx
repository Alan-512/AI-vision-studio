...
export const ProjectSidebar: React.FC<ProjectSidebarProps> = ({
  ...
  return (
    <div className="absolute top-0 bottom-0 left-20 w-72 bg-dark-panel border-r border-dark-border z-50 shadow-2xl shadow-black/50 flex flex-col animate-in slide-in-from-left-5 fade-in duration-200">
